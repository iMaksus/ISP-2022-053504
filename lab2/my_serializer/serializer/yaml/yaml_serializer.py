...
from .dto_serialize_yaml import DTO_FUNC, DTO_CODE, DTO_CLASS, DTO_OBJ, DTO_MODULE
from ...custom_functions import _select_globals_func, _select_fields_class, _select_attrs_module
...
class YamlSerializer():
    ...
    # converts Python object to YAML file
    ...
    # converts Python object to YAML string
